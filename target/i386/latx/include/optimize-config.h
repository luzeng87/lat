...
#undef CONFIG_LATX_LAZYLINK
#define CONFIG_LATX_LAZYLINK
#undef CONFIG_LATX_FAST_JMPCACHE
#define CONFIG_LATX_FAST_JMPCACHE
//#undef CONFIG_LATX_GLUE_MASK
//#define CONFIG_LATX_GLUE_MASK
#endif
